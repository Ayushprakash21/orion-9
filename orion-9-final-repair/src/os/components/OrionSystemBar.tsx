  ...
  return (
    <header className="orion-global-topbar relative top-auto left-auto right-auto h-[48px] min-h-[48px] w-full z-[10000] flex items-center justify-between px-3 md:px-4 text-[12px] font-medium text-os-text-secondary select-none bg-os-bg border-b border-os-border shadow-[0_1px_0_rgba(255,255,255,0.05)] pointer-events-auto shrink-0">
      ...
      <div className="flex items-center h-full gap-1 shrink-0 min-w-0">
        ...
        <div className="flex items-center h-full px-2 font-mono text-[11px] text-os-text-secondary">
