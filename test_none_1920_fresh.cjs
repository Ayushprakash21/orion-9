...
(async () => {
  ...
  const p = path.resolve('C:/Users/LENOVO/.gemini/antigravity/brain/2294112a-5564-4333-a185-061673183aaa/test_none_1920_fresh.png');
  await page.screenshot({ path: p });
  console.log('Saved test_none_1920_fresh.png');
