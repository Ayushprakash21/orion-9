...
export const userService = {
  ...
  updateUser: async (id: string, updates: Partial<UserProfile>): Promise<UserProfile | null> => {
    ...
    const updatedUser = {
      ...
      displayName: updates.displayName !== undefined ? updates.displayName : (updates.fullName !== undefined ? updates.fullName.split(' ')[0] : existingUser.displayName),
