...
const file = path.join(__dirname, 'src/services/SupplierEngine.ts');
let content = fs.readFileSync(file, 'utf8');

// I will just replace the whole file content
const newContent = `import { Supplier } from '../types';
...
console.log("Supplier engine updated");
