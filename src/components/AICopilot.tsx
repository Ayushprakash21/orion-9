...
export const AICopilot = () => {
  ...
  const [messages, setMessages] = useState<{role: 'user' | 'assistant', content: string}[]>([
    {
      role: 'assistant',
      content: 'Hello. I am ORION AI, your supply-chain decision assistant. I can analyze inventory, supplier performance, purchase orders, and exceptions. How can I assist you today?'
    }
  ]);
