  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 max-w-4xl h-full flex flex-col">
      <div>
        ...
        <p className="text-sm text-[#A0A0A0]">Manage administrator credentials and account security.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-1 lg:col-span-1">
          {[
            ...
            <button
              key={item.id}
              className="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors text-left text-[#A0A0A0] hover:text-[#F5F5F5] hover:bg-[#111111]"
            >
              <item.icon size={16} />
              {item.name}
            </button>
        ...
        <div className="lg:col-span-2 space-y-6">
          <form onSubmit={handleSave} className="p-6 rounded-lg border border-[#2A2A2A] bg-[#0A0A0A] space-y-6">
            <div>
              <h2 className="text-sm font-semibold uppercase tracking-wider text-[#F5F5F5] mb-4">Admin Credentials</h2>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-wider text-[#6F6F6F] font-semibold">Admin Username</label>
                  <input 
                    type="text"
                    required
                    value={adminId}
                ...
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-wider text-[#6F6F6F] font-semibold">New Password (Leave blank to keep current)</label>
                  <input 
                    type="password"
