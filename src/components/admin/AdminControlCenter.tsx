...
export const DOMAINS: Domain[] = [
  ...
  { id:'security', name:'Security', priority:'P0', description:'Security controls, secrets, audit and resilience.', capabilities:[
  ...
  { id:'master-data', name:'Master Data', priority:'P0', description:'Canonical suppliers, customers, SKUs, facilities and reference data.', capabilities:[
  ...
  { id:'procurement', name:'Procurement', priority:'P0', description:'Sourcing, purchase orders, approvals and supplier decisions.', capabilities:[
  ...
  { id:'inventory', name:'Inventory', priority:'P0', description:'Stock, replenishment, allocation and inventory policy.', capabilities:[
  ...
  { id:'order-management', name:'Order Management', priority:'P0', description:'Order lifecycle, pricing, allocation and returns.', capabilities:[
  ...
  { id:'warehouse', name:'Warehouse Management', priority:'P1', description:'Warehouse execution, locations, picking, packing and scanning.', capabilities:[
  ...
  { id:'transportation', name:'Transportation', priority:'P1', description:'Routes, freight, docks, carriers and delivery execution.', capabilities:[
  ...
  { id:'manufacturing', name:'Manufacturing', priority:'P1', description:'Production, quality, maintenance and OEE.', capabilities:[
  ...
  { id:'forecasting', name:'Forecasting / S&OP', priority:'P1', description:'Demand forecasting, sensing, consensus and planning.', capabilities:[
  ...
  { id:'analytics', name:'Analytics', priority:'P1', description:'KPIs, reports, anomalies and executive intelligence.', capabilities:[
  ...
  { id:'integrations', name:'Integrations', priority:'P1', description:'ERP, API, EDI, event and IoT connectivity.', capabilities:[
  ...
  { id:'compliance', name:'Compliance', priority:'P1', description:'Regulatory, sanctions, documents and evidence.', capabilities:[
  ...
  { id:'operations', name:'Operations', priority:'P1', description:'Runtime monitoring, releases, backups and operational health.', capabilities:[
  ...
  { id:'ai-ml', name:'AI / ML', priority:'P1', description:'Models, Copilot, Autopilot, optimization and learning.', capabilities:[
  ...
  { id:'portals', name:'Portals', priority:'P2', description:'Supplier, customer, carrier and distributor portals.', capabilities:[
  ...
  { id:'mobile', name:'Mobile', priority:'P2', description:'Mobile execution, devices, offline work and notifications.', capabilities:[
