  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-[#A0A0A0]">Toggle between Enterprise Demo dataset and local persistent data.</p>
      </div>
      
      <div className="p-6 rounded-lg border border-[#2A2A2A] bg-[#0A0A0A] space-y-6">
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wider text-[#F5F5F5] mb-2 flex items-center gap-2">
              <Database size={16} /> Current Data Mode
            </h2>
            <div className="flex items-center gap-3 mt-4">
              <span className="text-sm text-[#A0A0A0]">Active Mode:</span>
        ...
        <div className="pt-6 border-t border-[#2A2A2A]">
          <div className="flex flex-col gap-4">
            <div className="flex items-start justify-between p-4 border border-[#2A2A2A] rounded-lg bg-[#111111]">
              <div className="space-y-1">
                <h3 className="font-medium text-[#F5F5F5]">Load Enterprise Demo Data</h3>
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#1C1C1C] border border-[#2A2A2A] text-[#F5F5F5] rounded text-sm font-medium hover:bg-[#2A2A2A] transition-colors disabled:opacity-50"
              >
            ...
            <div className="flex items-start justify-between p-4 border border-[#2A2A2A] rounded-lg bg-[#111111]">
              <div className="space-y-1">
                <h3 className="font-medium text-[#F5F5F5]">Use Local Persistent Data (Empty Base)</h3>
                <p className="text-xs text-[#A0A0A0] max-w-md">
