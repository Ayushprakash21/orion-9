...
import { Save, Bell, Globe, Shield, Activity } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-[10px] uppercase tracking-widest text-[#F5F5F5] mb-1">SYSTEM PARAMS</h2>
          <p className="text-sm text-[#777777]">Configure thresholds, formats, and application preferences.</p>
        </div>
      </div>
      ...
      <div className="bg-[#151515] rounded-sm shadow-[0_0_20px_rgba(0,0,0,0.5)] border border-[#2A2A2A] overflow-hidden backdrop-blur-sm">
        <div className="p-6 border-b border-[#2A2A2A] bg-black/40">
          ...
          <p className="text-xs text-[#777777] mt-1">Determine when alerts and statuses are triggered. Changing these recalculates all KPIs.</p>
        </div>
