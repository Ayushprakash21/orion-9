...
export function OrionApplicationLauncher() {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={containerRef}
        className="relative w-[calc(100%-16px)] sm:w-full max-w-3xl max-h-[82vh] mb-16 md:mb-20 flex flex-col bg-black/60 backdrop-blur-2xl rounded-2xl border border-white/10 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.85),inset_0_1px_1px_rgba(255,255,255,0.06)] animate-in fade-in slide-in-from-bottom-8 duration-200"
