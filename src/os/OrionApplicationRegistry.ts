...
export const ORION_REGISTRY: Record<string, OrionApp> = {
  ...
  'global-operations': {
    ...
    route: '/admin/global-ops',
    category: 'Control',
    icon: Globe,
    color: '#A855F7',
    description: '7-level enterprise organizational hierarchy and multi-site sovereign governance.',
    dockDefault: false,
  },
  'regional-operations': {
    id: 'regional-operations',
    name: 'Regional Operations',
    route: '/admin/regional-ops',
    category: 'Control',
    icon: Globe2,
    color: '#06B6D4',
    description: 'Multi-region runtime topology, capacity limits, and sovereign data residency policies.',
    dockDefault: false,
  },
  'integration-gateway': {
    id: 'integration-gateway',
    name: 'Integration Gateway',
    route: '/admin/integration-gateway',
    category: 'Platform',
    icon: Network,
    color: '#00F2FE',
    description: 'Perimeter gateway, token bucket rate limiters, circuit breakers, and DLQ quarantine.',
    dockDefault: false,
  },
  'trading-partners': {
    id: 'trading-partners',
    name: 'Trading Partner Center',
    route: '/admin/trading-partners',
    category: 'Operations',
    icon: Users,
    color: '#8B5CF6',
    description: 'EDI trading partner lifecycle management and 8-point automated compliance certification.',
    dockDefault: false,
  },
  'reconciliation-center': {
    ...
    icon: DollarSign,
    color: '#F59E0B',
    description: 'Cross-system ledger reconciliation, discrepancy diagnostics, and exposure tracking.',
    dockDefault: false,
  },
  'failover-center': {
    id: 'failover-center',
    name: 'Failover & Fencing',
    route: '/admin/failover',
    category: 'Control',
    icon: ShieldAlert,
    color: '#EF4444',
    description: '6-phase multi-region failover execution protocol and distributed fencing token authority.',
    dockDefault: false,
  },
  'scale-performance': {
    id: 'scale-performance',
    name: 'Scale & Performance',
    route: '/admin/scale-performance',
    category: 'Platform',
    icon: Activity,
    color: '#10B981',
  ...
  'platform-maturity': {
    ...
    route: '/admin/maturity',
    category: 'Platform',
    icon: ShieldCheck,
    color: '#10B981',
    description: 'Enterprise operational maturity scorecard, telemetry audits, and compliance validation.',
    dockDefault: false,
  },
  'atp-center': {
    id: 'atp-center',
    name: 'ATP & Order Promising',
    route: '/operations/atp',
    category: 'Operations',
    icon: Target,
    color: '#00F2FE',
    description: 'Deterministic Available-to-Promise calculations, order netting, allocation reservation, and delivery commitments.',
    dockDefault: true,
  },
  'outbound-execution': {
    ...
    icon: Package,
    color: '#F59E0B',
    description: 'Wave release orchestration, RF/voice pick task execution, containerization, and SSCC carton labeling.',
    dockDefault: true,
  },
  'delivery-pod': {
    id: 'delivery-pod',
    name: 'Last-Mile & Digital POD',
    route: '/operations/delivery-pod',
    category: 'Operations',
    icon: Truck,
    color: '#3B82F6',
    description: 'Fleet carrier tracking, real-time geofenced milestones, and cryptographic e-signature Proof of Delivery.',
    dockDefault: true,
  },
  'finance-ledger': {
    id: 'finance-ledger',
    ...
    icon: DollarSign,
    color: '#10B981',
    description: 'Automated customer billing, 5-bucket AR aging, automated 3-way AP matching, and Working Capital Intelligence (CCC/DSO/DIO/DPO).',
    dockDefault: true,
  },
  'customs-trade': {
    id: 'customs-trade',
    name: 'Customs & Trade Compliance',
    route: '/compliance/customs',
    category: 'Control',
    icon: Globe,
    color: '#8B5CF6',
    description: 'International customs declarations, HS code classifications, tariff calculation, and port customs hold release management.',
    dockDefault: false,
  },
  'warranty-service': {
    id: 'warranty-service',
    ...
    icon: ShieldAlert,
    color: '#EC4899',
    description: 'Serialized warranty claim validation, supplier chargeback recovery, and Return-to-Vendor credit memo processing.',
    dockDefault: false,
  },
  'supplier-collaboration': {
    id: 'supplier-collaboration',
    name: 'Supplier CPFR & Capacity',
    route: '/suppliers/collaboration',
    category: 'Operations',
    icon: Users,
    color: '#06B6D4',
    description: 'Collaborative Planning, Forecasting, and Replenishment (CPFR), multi-tier supplier capacity planning, and VMI consignment.',
    dockDefault: false,
  },
  'network-design': {
    id: 'network-design',
    name: 'Network Design & Scenarios',
    route: '/intelligence/network-design',
    category: 'Intelligence',
    icon: Network,
    color: '#6366F1',
    description: 'Supply chain network topology modeling, candidate facility optimization scenarios, and lane freight consolidation.',
    dockDefault: false,
  },
  'sustainability': {
    id: 'sustainability',
    name: 'Sustainability & ESG Center',
    route: '/intelligence/sustainability',
    category: 'Intelligence',
    icon: Activity,
    color: '#10B981',
    description: 'Scope 1, 2, and 3 carbon emission accounting, CBAM compliance tracking, and recycled packaging circularity audits.',
    dockDefault: false,
  },
  'file-manager': {
    id: 'file-manager',
  ...
  'notepad': {
    ...
    icon: FileText,
    color: '#00F2FE',
    description: 'Full-featured desktop text editor, supply chain memos, and code notes.',
    dockDefault: true,
  },
  'orion-computer': {
    id: 'orion-computer',
  ...
  'orion-documents': {
    ...
    icon: FileText,
    color: '#0284C7',
    description: 'Enterprise word processor, rich document authoring, and supply chain contract editing.',
    dockDefault: true,
  },
  'orion-sheets': {
    id: 'orion-sheets',
    ...
    icon: BarChart2,
    color: '#10B981',
    description: 'Enterprise spreadsheet editor, financial matrix analysis, and formula engine.',
    dockDefault: true,
  },
  'orion-slides': {
    id: 'orion-slides',
    ...
    icon: LayoutDashboard,
    color: '#F59E0B',
    description: 'Executive presentation deck authoring, slide layouts, and SCM briefing engine.',
    dockDefault: true,
  },
  'orion-pdf': {
    id: 'orion-pdf',
