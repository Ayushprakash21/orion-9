  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 h-full flex flex-col relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-light tracking-tight mb-2 text-os-text-primary">Organizations</h1>
          <p className="text-sm text-os-text-secondary">Manage enterprise tenants, regional workspaces, and organization-level branding.</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full sm:w-60 bg-os-bg border border-os-border rounded-md py-2 pl-9 pr-4 text-sm text-os-text-primary focus:outline-none focus:border-os-border"
            />
          </div>
      ...
      <div className="flex-1 rounded-lg border border-os-border bg-os-bg overflow-hidden flex flex-col shadow-xl">
        {filteredOrganizations.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center border-t border-os-border">
            ...
            <h3 className="text-lg font-medium text-os-text-primary mb-2">No organizations found</h3>
            ...
            <table className="min-w-full divide-y divide-[#2A2A2A]">
              <thead className="bg-os-surface">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-os-text-secondary uppercase tracking-wider">Industry</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-os-text-secondary uppercase tracking-wider">Country</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-os-text-secondary uppercase tracking-wider">Users</th>
              ...
              <tbody className="bg-os-bg divide-y divide-[#2A2A2A]">
                {filteredOrganizations.map((org) => {
                  ...
                  return (
                    <tr key={org.id} className="hover:bg-os-surface-hover transition-colors group">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          {/* Organization Custom Logo or Fallback Emblem */}
                          <div className="flex-shrink-0 h-10 w-10 rounded-lg bg-os-surface-elevated flex items-center justify-center border border-os-border overflow-hidden">
                          ...
                          <div className="ml-4">
                            <div className="text-sm font-medium text-os-text-primary">{org.name}</div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-os-text-secondary">
                        {org.industry || 'Supply Chain / Logistics'}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-os-text-secondary">
                        <span className="flex items-center gap-1.5">
                          <Globe size={13} className="text-os-text-muted" />
                          {org.country || 'Global'}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-mono rounded-full bg-os-surface text-os-text-secondary border border-os-border">
                          <UsersIcon size={12} className="text-os-text-muted" />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-os-bg border border-os-border rounded-xl w-full max-w-xl overflow-hidden shadow-2xl max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-os-border shrink-0">
              <div>
                <h2 className="text-lg font-medium text-os-text-primary">Create Organization</h2>
                <p className="text-xs text-os-text-secondary">Configure a new enterprise workspace, regional parameters, and logo.</p>
              </div>
              <button 
            ...
            <form onSubmit={handleCreateOrganization} className="p-6 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary">Organization Name *</label>
                <input 
                  type="text" 
                  value={newName}
                  onChange={e => {
                  ...
                  className={cn(
                    ...
                    createErrors.name ? "border-red-500" : "border-os-border focus:border-os-border"
                  )}
                />
                {createErrors.name && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary">Industry *</label>
                  <input 
                    type="text" 
                    value={newIndustry}
                    onChange={e => {
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary">Country *</label>
                  <input 
                    type="text" 
                    value={newCountry}
                    onChange={e => {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary">Currency *</label>
                  <select 
                    value={newCurrency}
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary">Timezone *</label>
                  <select 
                    value={newTimezone}
              ...
              <div className="space-y-2 pt-3 border-t border-os-border">
                <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-os-text-muted">distinct from application logo</span>
                </label>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-lg bg-os-surface border border-os-border flex items-center justify-center overflow-hidden shrink-0">
                    {newLogoUrl ? (
                      <img src={newLogoUrl} alt="Preview" className="w-full h-full object-contain p-1" referrerPolicy="no-referrer" />
                    ) : (
                      <Building2 size={20} className="text-os-text-muted" />
                    )}
                  </div>
                  <div className="flex-1 space-y-2">
                    <input 
                      ...
                      className="w-full bg-os-surface border border-os-border rounded p-2 text-xs text-os-text-primary focus:outline-none focus:border-os-border"
                    />
                    <div className="flex items-center gap-2">
                      <button 
                        type="button"
                        onClick={() => createLogoInputRef.current?.click()}
                        className="px-3 py-1 bg-os-surface border border-os-border rounded text-xs text-os-text-secondary hover:text-os-text-primary hover:bg-os-surface-hover transition-colors flex items-center gap-1.5 cursor-pointer"
                      >
      ...
      {editingOrg && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-os-bg border border-os-border rounded-xl w-full max-w-xl overflow-hidden shadow-2xl max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-os-border shrink-0">
              <div>
                <h2 className="text-lg font-medium text-os-text-primary">Edit Organization</h2>
                <p className="text-xs text-os-text-secondary">Update tenant parameters and organization branding.</p>
              </div>
              <button 
            ...
            <form onSubmit={handleUpdateOrganization} className="p-6 space-y-4 overflow-y-auto flex-1">
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className={cn(
                    "w-full bg-os-surface border rounded p-2.5 text-sm text-os-text-primary focus:outline-none",
                    editErrors.name ? "border-red-500" : "border-os-border focus:border-os-border"
                  )}
                />
                {editErrors.name && (
              ...
              <div className="space-y-2 pt-3 border-t border-os-border">
                <label className="text-[10px] font-semibold uppercase tracking-wider text-os-text-secondary flex items-center justify-between">
                  <span>Organization Logo</span>
                  <span className="text-[10px] text-os-text-muted">shown in organization profile</span>
                </label>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-lg bg-os-surface border border-os-border flex items-center justify-center overflow-hidden shrink-0">
                    {editLogoUrl ? (
      ...
      {deletingOrg && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-os-bg border border-os-border rounded-xl w-full max-w-md overflow-hidden shadow-2xl p-6 space-y-4">
            ...
            <h3 className="text-lg font-medium text-os-text-primary">Delete Organization</h3>
            <p className="text-sm text-os-text-secondary">
              Are you sure you want to delete <strong className="text-os-text-primary">{deletingOrg.name}</strong>? 
