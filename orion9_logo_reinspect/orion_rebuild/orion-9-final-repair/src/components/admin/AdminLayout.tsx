...
export const AdminLayout = () => {
  ...
  return (
    <div className="orion-admin-shell flex flex-col h-screen w-full bg-os-bg text-os-text-secondary font-sans overflow-hidden box-border">
      ...
      <header className="orion-admin-topbar flex items-center justify-between h-12 min-h-12 max-h-12 px-4 sm:px-6 lg:px-8 bg-os-bg border-b border-os-border shrink-0 box-border w-full z-50">
