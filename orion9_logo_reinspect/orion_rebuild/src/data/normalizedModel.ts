...
export const demoDocuments: DocumentRecord[] = [
  {
    ...
    extractedFields: {
      contractNumber: 'MSA-ORION-SUP001',
      parties: ['Orion SCM OS Corp', 'Supplier A Tech Ltd.'],
...
export const demoSupplierCommunications: SupplierCommunication[] = [
  {
    ...
    body: 'Dear Supplier A Operations Team, Our Orion SCM OS has flagged PO-2026-0001 as delayed by 5 days against committed milestone. Downstream manufacturing is exposed. Please provide confirmed revised dispatch date within 24h.',
    type: 'PO_STATUS',
    status: 'DISPATCHED',
