...
export const Login: React.FC = () => {
  ...
  return (
    <div className="orion-user-login-shell w-screen h-[100dvh] max-h-[100dvh] bg-os-bg text-os-text-primary flex flex-col md:flex-row overflow-hidden font-sans relative selection:bg-[#00F2FE]/30">
      
      {/* LEFT PANEL: AUTHENTICATION & ORION SCM IDENTITY */}
      <div className="orion-user-login-panel w-full md:w-[420px] lg:w-[460px] xl:w-[480px] h-full min-h-0 flex flex-col relative z-20 bg-os-bg border-b md:border-b-0 md:border-r border-os-border shrink-0 overflow-hidden">
      ...
      <div className="hidden md:flex flex-1 relative bg-[#06080D] overflow-hidden select-none flex-col">
        ...
        <div className="orion-user-login-twin flex-1 min-w-0 h-full min-h-0"><ScmNetworkTwin variant="desktop" mode="user" className="w-full h-full" /></div>
      </div>
    </div>
  );
};
