...
export const AdminLogin: React.FC = () => {
  const { login, isAuthenticated, hasRole, isPostLoginInitializing, triggerShutdown } = useAuth();
  ...
  return (
    <div className="orion-admin-login-shell w-screen h-[100dvh] max-h-[100dvh] bg-os-bg text-os-text-primary flex flex-col lg:flex-row overflow-hidden font-sans relative selection:bg-os-accent/30">
      {/* ========================================================================= */}
      {/* MAIN LEFT AREA (~68-70% ON DESKTOP): IMMERSIVE ORION-9 CONTROL PLANE */}
      {/* ========================================================================= */}
      <div className="orion-admin-login-twin flex-1 min-w-0 h-full min-h-0 relative bg-os-bg overflow-hidden select-none flex flex-col border-b lg:border-b-0 lg:border-r border-os-border">
      ...
      {/* ========================================================================= */}
      <div className="orion-admin-login-panel w-full lg:w-[380px] xl:w-[420px] 2xl:w-[450px] h-full min-h-0 flex flex-col relative z-20 bg-os-bg justify-center overflow-y-auto">
