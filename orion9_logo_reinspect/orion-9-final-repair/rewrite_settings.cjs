          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-widest font-medium text-os-text-secondary mb-2">Healthy Stock (Days)</label>
                  <input name="healthyStockDays" value={localSettings.healthyStockDays ?? ''} onChange={handleChange} type="number" min="1" max="180" className="w-full rounded-lg border border-os-border-strong bg-os-input-bg px-3 py-2 text-sm font-mono text-os-text-primary focus:outline-none focus:border-os-text-muted transition-colors" />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest font-medium text-os-text-secondary mb-2">High Demand (Units/Day)</label>
                  <input name="highDemandThreshold" value={localSettings.highDemandThreshold ?? ''} onChange={handleChange} type="number" min="1" max="10000" className="w-full rounded-lg border border-os-border-strong bg-os-input-bg px-3 py-2 text-sm font-mono text-os-text-primary focus:outline-none focus:border-os-text-muted transition-colors" />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest font-medium text-os-text-secondary mb-2">Delayed Delivery (Hours)</label>
                  <input name="delayedDeliveryHours" value={localSettings.delayedDeliveryHours ?? ''} onChange={handleChange} type="number" min="0" max="720" className="w-full rounded-lg border border-os-border-strong bg-os-input-bg px-3 py-2 text-sm font-mono text-os-text-primary focus:outline-none focus:border-os-text-muted transition-colors" />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest font-medium text-os-text-secondary mb-2">Risk Tolerance (0-100)</label>
                  <input name="riskToleranceScore" value={localSettings.riskToleranceScore ?? ''} onChange={handleChange} type="number" min="0" max="100" className="w-full rounded-lg border border-os-border-strong bg-os-input-bg px-3 py-2 text-sm font-mono text-os-text-primary focus:outline-none focus:border-os-text-muted transition-colors" />
                </div>
                <div>
