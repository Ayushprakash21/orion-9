...
import { AdminAutonomousOperations } from './components/admin/AdminAutonomousOperations';
    ...
    <Routes>
      ...
      {isAdmin && (
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="autonomous-operations" element={<AdminAutonomousOperations />} />
...
function AppBootstrap() {
  ...
  const trueTone = supplyChain?.settings?.trueTone;
  ...
  React.useEffect(() => {
    ...
    if (trueTone) {
      ...
      document.documentElement.classList.remove('true-tone');
    }
