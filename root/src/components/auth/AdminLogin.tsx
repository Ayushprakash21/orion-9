    ...
    <div className="w-screen h-[100dvh] max-h-[100dvh] bg-os-bg text-os-text-primary flex flex-col lg:flex-row overflow-hidden font-sans relative selection:bg-os-accent/30">
      ...
      <div className="w-full lg:w-[380px] xl:w-[420px] 2xl:w-[450px] h-full min-h-0 flex flex-col relative z-20 bg-os-bg justify-center overflow-y-auto">
        <div className="flex-1 flex flex-col justify-center px-6 sm:px-8 xl:px-10 py-10 w-full max-w-[420px] mx-auto">
          ...
          {/* AUTH FOOTER: SHUTDOWN (LEFT) & USER LOGIN (RIGHT) */}
          <div className="w-full flex items-center justify-between gap-3 pt-5 pb-1 shrink-0">
            <button
              type="button"
              onClick={triggerShutdown}
              className="inline-flex items-center justify-center gap-2 min-w-[150px] px-4 py-3 rounded-xl border border-red-500/20 bg-red-950/20 text-[11px] font-mono font-bold tracking-[0.16em] uppercase text-red-300/80 hover:text-red-200 hover:border-red-500/50 hover:bg-red-950/40 transition-all duration-200 shadow-lg"
              aria-label="Shut down ORION-9"
            >
