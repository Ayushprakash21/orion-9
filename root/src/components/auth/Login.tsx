  ...
  return (
    <div className="w-screen h-[100dvh] max-h-[100dvh] bg-os-bg text-os-text-primary flex flex-col md:flex-row overflow-hidden font-sans relative selection:bg-[#00F2FE]/30">
      ...
      <div className="w-full md:w-[420px] lg:w-[460px] xl:w-[480px] h-full min-h-0 flex flex-col relative z-20 bg-os-bg border-b md:border-b-0 md:border-r border-os-border shrink-0 overflow-hidden">
        ...
        {/* BOTTOM NAVIGATION BAR: SHUTDOWN (LEFT) & ADMIN CONSOLE (RIGHT) */}
        <div className="w-full min-h-[64px] p-3 sm:p-4 lg:p-6 flex items-center justify-between gap-3 shrink-0 border-t border-white/5">
          <button
            type="button"
            onClick={triggerShutdown}
            className="inline-flex items-center gap-2 px-4 py-2 text-[11px] font-mono font-bold tracking-widest uppercase text-red-300/80 hover:text-red-200 bg-red-950/20 hover:bg-red-950/40 rounded-xl border border-red-500/20 hover:border-red-500/50 shadow-lg transition-all cursor-pointer"
