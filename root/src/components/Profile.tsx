...
export const Profile = ({ initialTab = 'profile' }: { initialTab?: 'profile' | 'organization' | 'preferences' | 'security' }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-os-bg text-os-text-primary">
      <div className="shrink-0 px-4 sm:px-6 lg:px-8 py-6 border-b border-os-border box-border w-full max-w-none mx-0">
      ...
      <div className="flex-1 overflow-auto px-4 sm:px-6 lg:px-8 py-8 box-border w-full max-w-none mx-0">
