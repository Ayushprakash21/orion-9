...
import { 
  ...
  Building2, Shield, BrainCircuit, Sparkles, BookOpen
} from 'lucide-react';
...
export const AdminLayout = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: 'Autonomous Operations', path: '/admin/autonomous-operations', icon: Sparkles },
    ...
    { name: 'Admin Manual', path: '/admin/manual', icon: BookOpen },
  ];
